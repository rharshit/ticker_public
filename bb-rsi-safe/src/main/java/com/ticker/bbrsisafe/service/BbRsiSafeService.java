...
public class BbRsiSafeService extends StratTickerService<BbRsiSafeThread, BbRsiSafeThreadModel> {
    ...
    private static final Map<Integer, String> stateValueMap = new HashMap<Integer, String>() {{
        put(BB_RSI_SAFE_THREAD_STATE_STRAT_FAILED, "Thread failed");
        put(BB_RSI_SAFE_THREAD_STATE_WAITING_FOR_TRIGGER, "Waiting for trigger");
        put(BB_RSI_SAFE_THREAD_STATE_LT_TRIGGER_START, "Lower trigger started");
        put(BB_RSI_SAFE_THREAD_STATE_UT_TRIGGER_START, "Upper trigger started");
        put(BB_RSI_SAFE_THREAD_STATE_LT_TRIGGER_END1, "Lower trigger ended1");
        put(BB_RSI_SAFE_THREAD_STATE_LT_TRIGGER_END2, "Lower trigger ended2");
        put(BB_RSI_SAFE_THREAD_STATE_UT_TRIGGER_END1, "Upper trigger ended1");
        put(BB_RSI_SAFE_THREAD_STATE_UT_TRIGGER_END2, "Upper trigger ended2");
        put(BB_RSI_SAFE_THREAD_STATE_LT_BOUGHT, "Lower trigger bought");
        put(BB_RSI_SAFE_THREAD_STATE_UT_SOLD, "Upper trigger sold");
        put(BB_RSI_SAFE_THREAD_STATE_LT_WAIT_END_WAVE, "Waiting for lower wave to end");
        put(BB_RSI_SAFE_THREAD_STATE_UT_WAIT_END_WAVE, "Waiting for upper wave to end");
        put(BB_RSI_SAFE_THREAD_STATE_LT_WAIT_WAVE_ENDED1, "Lower trigger wave ended1");
        put(BB_RSI_SAFE_THREAD_STATE_LT_WAIT_WAVE_ENDED2, "Lower trigger wave ended2");
        put(BB_RSI_SAFE_THREAD_STATE_LT_WAIT_WAVE_ENDED3, "Lower trigger wave ended3");
        put(BB_RSI_SAFE_THREAD_STATE_UT_WAIT_WAVE_ENDED1, "Upper trigger wave ended1");
        put(BB_RSI_SAFE_THREAD_STATE_UT_WAIT_WAVE_ENDED2, "Upper trigger wave ended2");
        put(BB_RSI_SAFE_THREAD_STATE_UT_WAIT_WAVE_ENDED3, "Upper trigger wave ended3");
        put(BB_RSI_SAFE_THREAD_STATE_LT_WAIT_WAVE_SOLD, "Lower trigger sold SO");
        put(BB_RSI_SAFE_THREAD_STATE_UT_WAIT_WAVE_BOUGHT, "Lower trigger bought SO");
        put(BB_RSI_SAFE_THREAD_STATE_LT_WAIT_WAVE_REVENGE, "Lower trigger revenge trading");
        put(BB_RSI_SAFE_THREAD_STATE_UT_WAIT_WAVE_REVENGE, "Upper trigger revenge trading");
        put(BB_RSI_SAFE_THREAD_STATE_LT_PANIC_SELL, "Lower trigger panic sell");
        put(BB_RSI_SAFE_THREAD_STATE_UT_PANIC_BUY, "Upper trigger panic buy");
        put(BB_RSI_SAFE_THREAD_STATE_LT_GTT_FAILED, "Lower trigger GTT fail");
        put(BB_RSI_SAFE_THREAD_STATE_UT_GTT_FAILED, "Upper trigger GTT fail");
        put(BB_RSI_SAFE_THREAD_STATE_LT_REENTER, "Lower trigger Re-enter");
        put(BB_RSI_SAFE_THREAD_STATE_UT_REENTER, "Upper trigger Re-enter");
    }};

    @Override
    public BbRsiSafeThreadModel createTickerThreadModel(BbRsiSafeThread thread) {
        return new BbRsiSafeThreadModel(thread);
    }

    @Override
    public void doAction(BbRsiSafeThread thread) {
        ...
        synchronized (thread) {
            ...
            try {
                switch (thread.getCurrentState()) {
                    case BB_RSI_SAFE_THREAD_STATE_STRAT_FAILED:
                        thread.destroy();
                        break;
                    case 0:
                        thread.setCurrentState(BB_RSI_SAFE_THREAD_STATE_WAITING_FOR_TRIGGER);
                        break;
                    case BB_RSI_SAFE_THREAD_STATE_WAITING_FOR_TRIGGER:
                        checkTrigger(thread);
                        break;
                    case BB_RSI_SAFE_THREAD_STATE_LT_TRIGGER_START:
                        checkForLtEnd(thread);
                        break;
                    case BB_RSI_SAFE_THREAD_STATE_LT_TRIGGER_END1:
                        checkForLtEnd1(thread);
                        break;
                    case BB_RSI_SAFE_THREAD_STATE_UT_TRIGGER_START:
                        checkForUtEnd(thread);
                        break;
                    case BB_RSI_SAFE_THREAD_STATE_UT_TRIGGER_END1:
                        checkForUtEnd1(thread);
                        break;
                    case BB_RSI_SAFE_THREAD_STATE_LT_TRIGGER_END2:
                        buyAction1(thread);
                        break;
                    case BB_RSI_SAFE_THREAD_STATE_UT_TRIGGER_END2:
                        sellAction1(thread);
                        break;
                    case BB_RSI_SAFE_THREAD_STATE_LT_BOUGHT:
                        thread.setCurrentState(BB_RSI_SAFE_THREAD_STATE_LT_WAIT_END_WAVE);
                        break;
                    case BB_RSI_SAFE_THREAD_STATE_UT_SOLD:
                        thread.setCurrentState(BB_RSI_SAFE_THREAD_STATE_UT_WAIT_END_WAVE);
                        break;
                    case BB_RSI_SAFE_THREAD_STATE_LT_WAIT_END_WAVE:
                        checkForLtWaveEnd(thread);
                        break;
                    case BB_RSI_SAFE_THREAD_STATE_UT_WAIT_END_WAVE:
                        checkForUtWaveEnd(thread);
                        break;
                    case BB_RSI_SAFE_THREAD_STATE_LT_WAIT_WAVE_ENDED1:
                        checkForLtWaveEnd1(thread);
                        break;
                    case BB_RSI_SAFE_THREAD_STATE_UT_WAIT_WAVE_ENDED1:
                        checkForUtWaveEnd1(thread);
                        break;
                    case BB_RSI_SAFE_THREAD_STATE_LT_WAIT_WAVE_ENDED2:
                        sellAction2(thread);
                        break;
                    case BB_RSI_SAFE_THREAD_STATE_UT_WAIT_WAVE_ENDED2:
                        buyAction2(thread);
                        break;
                    case BB_RSI_SAFE_THREAD_STATE_LT_WAIT_WAVE_REVENGE:
                        sellActionRevenge(thread);
                        break;
                    case BB_RSI_SAFE_THREAD_STATE_UT_WAIT_WAVE_REVENGE:
                        buyActionRevenge(thread);
                        break;
                    case BB_RSI_SAFE_THREAD_STATE_LT_PANIC_SELL:
                        panicSell(thread);
                        break;
                    case BB_RSI_SAFE_THREAD_STATE_UT_PANIC_BUY:
                        panicBuy(thread);
                        break;
                    case BB_RSI_SAFE_THREAD_STATE_LT_WAIT_WAVE_SOLD:
                    case BB_RSI_SAFE_THREAD_STATE_UT_WAIT_WAVE_BOUGHT:
                        resetThread(thread);
                        break;
                }
            } catch (Exception e) {
    ...
    private void buyActionRevenge(BbRsiSafeThread thread) {
    ...
    private void sellActionRevenge(BbRsiSafeThread thread) {
    ...
    private void buyAction2(BbRsiSafeThread thread) {
        log.debug(thread.getThreadName() + " : Buy action 2");
        try {
            squareOff(thread);
            thread.setCurrentState(BB_RSI_SAFE_THREAD_STATE_UT_WAIT_WAVE_BOUGHT);
            thread.setTradeStartTime(System.currentTimeMillis());
    ...
    private void sellAction2(BbRsiSafeThread thread) {
        log.debug(thread.getThreadName() + " : Sell action 2");
        try {
            squareOff(thread);
            thread.setCurrentState(BB_RSI_SAFE_THREAD_STATE_LT_WAIT_WAVE_SOLD);
            thread.setTradeStartTime(System.currentTimeMillis());
    ...
    private void checkForUtWaveEnd1(BbRsiSafeThread thread) {
        log.trace("");
        log.trace(thread.getThreadName() + " : checkForUtWaveEnd1");
        checkUtPanicExit(thread);
        checkUtSatisfy(thread);
        if (thread.getCurrentState() == BB_RSI_SAFE_THREAD_STATE_UT_WAIT_WAVE_BOUGHT
                || thread.getCurrentState() == BB_RSI_SAFE_THREAD_STATE_UT_WAIT_WAVE_ENDED2
                || thread.getCurrentState() == BB_RSI_SAFE_THREAD_STATE_UT_REENTER
                || thread.getCurrentState() == BB_RSI_SAFE_THREAD_STATE_UT_SOLD) {
            return;
        }
        ...
        if (thread.getCurrentState() == BB_RSI_SAFE_THREAD_STATE_UT_WAIT_WAVE_ENDED2) {
            buyAction2(thread);
        }
    }

    private void checkUtSatisfy(BbRsiSafeThread thread) {
        if (thread.isSatisfied()) {
            float curr = thread.getCurrentValue();
            float trail = thread.getTrailValue();
            float newTrail = curr + ((2 * thread.getTargetThreshold()) / 3);
    ...
    private void checkForLtWaveEnd1(BbRsiSafeThread thread) {
        ...
        if (thread.getCurrentState() == BB_RSI_SAFE_THREAD_STATE_LT_WAIT_WAVE_SOLD
                || thread.getCurrentState() == BB_RSI_SAFE_THREAD_STATE_LT_WAIT_WAVE_ENDED2
                || thread.getCurrentState() == BB_RSI_SAFE_THREAD_STATE_LT_REENTER
                || thread.getCurrentState() == BB_RSI_SAFE_THREAD_STATE_LT_BOUGHT) {
            return;
        }
        if (isSameMinTrigger(thread.getTriggerStartTime()) || !isEomTrigger()) {
            log.trace(thread.getThreadName() + " : No check");
        ...
        thread.setTriggerWaveEndTime(System.currentTimeMillis());
        if (thread.getCurrentState() == BB_RSI_SAFE_THREAD_STATE_LT_WAIT_WAVE_ENDED2) {
            sellAction2(thread);
        }
    }

    private void checkLtSatisfy(BbRsiSafeThread thread) {
        if (thread.isSatisfied()) {
            float curr = thread.getCurrentValue();
            float trail = thread.getTrailValue();
            float newTrail = curr - ((2 * thread.getTargetThreshold()) / 3);
    ...
    private void checkForUtWaveEnd(BbRsiSafeThread thread) {
        ...
        if (isUpwardTrend(thread)) {
            ...
            thread.setCurrentState(BB_RSI_SAFE_THREAD_STATE_UT_WAIT_WAVE_ENDED1);
            thread.setTriggerWaveEndTime(System.currentTimeMillis());
        }
    }

    private void checkUtPanicExit(BbRsiSafeThread thread) {
    ...
    private void panicBuy(BbRsiSafeThread thread) {
        ...
        if (thread.getPanicBuy() > PANIC_TIME_OFF) {
            thread.setCurrentState(BB_RSI_SAFE_THREAD_STATE_UT_PANIC_BUY);
            try {
                float tradeStart = thread.getTrailValue();
    ...
    private void checkForLtWaveEnd(BbRsiSafeThread thread) {
        log.trace("");
        ...
        if (isDownwardTrend(thread)) {
            ...
            thread.setCurrentState(BB_RSI_SAFE_THREAD_STATE_LT_WAIT_WAVE_ENDED1);
            thread.setTriggerWaveEndTime(System.currentTimeMillis());
        }
    }

    private void checkLtPanicExit(BbRsiSafeThread thread) {
    ...
    private void panicSell(BbRsiSafeThread thread) {
        ...
        if (thread.getPanicSell() > PANIC_TIME_OFF) {
            thread.setCurrentState(BB_RSI_SAFE_THREAD_STATE_LT_PANIC_SELL);
            try {
                float tradeStart = thread.getTrailValue();
                log.info(thread.getThreadName() + " : panic square-off");
                float tradeEnd = squareOff(thread);
    ...
    private void buyAction1(BbRsiSafeThread thread) {
        log.debug(thread.getThreadName() + " : Panic buy");
        try {
            buy(thread, thread.getEntity().getMinQty());
            thread.setCurrentState(BB_RSI_SAFE_THREAD_STATE_LT_BOUGHT);
            thread.setTradeStartTime(System.currentTimeMillis());
    ...
    private void sellAction1(BbRsiSafeThread thread) {
        log.debug(thread.getThreadName() + " : Sell action 1");
        try {
            sell(thread, thread.getEntity().getMinQty());
            thread.setCurrentState(BB_RSI_SAFE_THREAD_STATE_UT_SOLD);
            thread.setTradeStartTime(System.currentTimeMillis());
            thread.setTradeValue(thread.getCurrentValue());
            thread.setTrailValue(thread.getCurrentValue());
        } catch (Exception e) {
    ...
    private void checkForLtEnd(BbRsiSafeThread thread) {
        log.trace(thread.getThreadName() + " : checkForLtEnd");
        checkLtGTT(thread);
        checkPreMatureLtEnd(thread);
        if (thread.getCurrentState() == BB_RSI_SAFE_THREAD_STATE_LT_TRIGGER_END2) {
    ...
    private void checkLtGTT(BbRsiSafeThread thread) {
        ...
        if (!thread.isGoodToTrigger() && thread.getRsi() > RSI_LOWER_LIMIT_REBOUND) {
            thread.setIntermediateState(BB_RSI_SAFE_THREAD_STATE_LT_GTT_FAILED, BB_RSI_SAFE_THREAD_STATE_WAITING_FOR_TRIGGER);
        }
    }
    ...
    private void checkForLtEnd1(BbRsiSafeThread thread) {
    ...
    private void checkForUtEnd(BbRsiSafeThread thread) {
        log.trace(thread.getThreadName() + " : checkForUtEnd");
        checkUtGTT(thread);
        checkPreMatureUtEnd(thread);
        if (thread.getCurrentState() == BB_RSI_SAFE_THREAD_STATE_UT_TRIGGER_END2) {
    ...
    private void checkUtGTT(BbRsiSafeThread thread) {
        ...
        if (!thread.isGoodToTrigger() && thread.getRsi() < RSI_UPPER_LIMIT_REBOUND) {
            thread.setIntermediateState(BB_RSI_SAFE_THREAD_STATE_UT_GTT_FAILED, BB_RSI_SAFE_THREAD_STATE_WAITING_FOR_TRIGGER);
        }
    }
    ...
    private void checkForUtEnd1(BbRsiSafeThread thread) {
